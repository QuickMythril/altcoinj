...
/**
 * Parameters for the VerusCoin main production network on which people trade
 * goods and services.
 */
public class VerusCoinMainNetParams extends AbstractVerusCoinParams {
    public static final int MAINNET_MAJORITY_WINDOW = 4000;
    public static final int MAINNET_MAJORITY_REJECT_BLOCK_OUTDATED = 950;
    public static final int MAINNET_MAJORITY_ENFORCE_BLOCK_UPGRADE = 750;

    public VerusCoinMainNetParams() {
        super();
        id = ID_VRSC_MAINNET;
        ...
        addressHeader = 60;
        p2shHeader = 85;
        // from https://github.com/VerusCoin/VerusCoin/blob/master/src/chainparams.cpp
        ...
        dnsSeeds = new String[] {
            ...
            "seed-raven.verusCoin.com",
            "seed-raven.verusCoin.org"
        };
    ...
    private static AltcoinBlock createGenesis(NetworkParameters params) {
        ...
        AltcoinBlock genesisBlock = new AltcoinBlock(params, 4, Sha256Hash.ZERO_HASH,
                merkleRoot, 1231006505L, 0x1f07ffffL, 0x0bL, Arrays.asList(t));
                // from https://github.com/VerusCoin/VerusCoin/blob/master/src/chainparams.cpp

        return genesisBlock;
    }

    private static VerusCoinMainNetParams instance;
    public static synchronized VerusCoinMainNetParams get() {
        if (instance == null) {
            instance = new VerusCoinMainNetParams();
        }
        return instance;
    }
