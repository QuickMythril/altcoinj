 ...
 * Thanks to https://github.com/KomodoPlatform/komodoj for the references
 */
...
/**
 * Common parameters for Komodo networks.
 */
public abstract class AbstractKomodoParams extends NetworkParameters implements AltcoinNetworkParameters {
    /** Standard format for the KMD denomination. */
    public static final MonetaryFormat KMD;
    /** Standard format for the mKMD denomination. */
    public static final MonetaryFormat MKMD;
    /** Standard format for the "Komodoshi" denomination. */
    public static final MonetaryFormat KOMODOSHI;

    public static final int KOMODO_TARGET_TIMESPAN = (int)(2016 * 60);  // fixme
    public static final int KOMODO_TARGET_SPACING = (int)(1 * 60);  // 60 seconds
    public static final int KOMODO_INTERVAL = TARGET_TIMESPAN / TARGET_SPACING;

    /**
     * The maximum number of coins to be generated
     */
    public static final long MAX_COINS = 200000000; // 200000000;

    /**
     * The maximum money to be generated
     */
    public static final Coin MAX_KOMODO_MONEY = COIN.multiply(MAX_COINS);

    /** Currency code for base 1 Komodo. */
    public static final String CODE_KMD = "KMD";
    /** Currency code for base 1/1,000 Komodo. */
    public static final String CODE_MKMD = "mKMD";
    /** Currency code for base 1/100,000,000 Komodo. */
    public static final String CODE_KOMODOSHI = "Komodoshi";

    static {
        KMD = MonetaryFormat.BTC.noCode()
            .code(0, CODE_KMD)
            .code(3, CODE_MKMD)
            .code(7, CODE_KOMODOSHI);
        MKMD = KMD.shift(3).minDecimals(2).optionalDecimals(2);
        KOMODOSHI = KMD.shift(7).minDecimals(0).optionalDecimals(2);
    }

    /** The string returned by getId() for the main, production network where people trade things. */
    public static final String ID_KMD_MAINNET = "main";
    /** The string returned by getId() for the testnet. */
    public static final String ID_KMD_TESTNET = "test";
    /** The string returned by getId() for regtest. */
    public static final String ID_KMD_REGTEST = "regtest";

    public static final int KOMODO_PROTOCOL_VERSION_MINIMUM = 170007; // fixme
    public static final int KOMODO_PROTOCOL_VERSION_CURRENT = 170007; // fixme

    private static final Coin BASE_SUBSIDY = Coin.valueOf(5000, 0); // fixme

    protected Logger log = LoggerFactory.getLogger(AbstractKomodoParams.class);

    public AbstractKomodoParams() {
        super();
        interval = KOMODO_INTERVAL;
        targetTimespan = KOMODO_TARGET_TIMESPAN;
     ...
     * TODO: this may need updating for Komodo; it is currently copied from Litecoin
     *
    ...
    public int getProtocolVersionNum(final ProtocolVersion version) {
        switch (version) {
            ...
            case CURRENT:
                return KOMODO_PROTOCOL_VERSION_CURRENT;
            case MINIMUM:
            default:
                return KOMODO_PROTOCOL_VERSION_MINIMUM;
        }
    }
