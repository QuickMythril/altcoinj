...
/**
 * Common parameters for Zcash networks.
 */
public abstract class AbstractZcashParams extends NetworkParameters implements AltcoinNetworkParameters {
    /** Standard format for the ZEC denomination. */
    public static final MonetaryFormat ZEC;
    /** Standard format for the mZEC denomination. */
    public static final MonetaryFormat MZEC;
    /** Standard format for the "Zatoshi" denomination. */
    public static final MonetaryFormat ZATOSHI;

    public static final int ZCASH_TARGET_TIMESPAN = (int)(2016 * 60); // fixme
    public static final int ZCASH_TARGET_SPACING = (int)(1 * 60); // fixme
    public static final int ZCASH_INTERVAL = TARGET_TIMESPAN / TARGET_SPACING;
     ...
     */
    public static final Coin MAX_ZCASH_MONEY = COIN.multiply(MAX_COINS);

    /** Currency code for base 1 Zcash. */
    public static final String CODE_ZEC = "ZEC";
    /** Currency code for base 1/1,000 Zcash. */
    public static final String CODE_MZEC = "mZEC";
    /** Currency code for base 1/100,000,000 Zcash. */
    public static final String CODE_ZATOSHI = "Zatoshi";

    static {
        ZEC = MonetaryFormat.BTC.noCode()
            .code(0, CODE_ZEC)
            .code(3, CODE_MZEC)
            .code(7, CODE_ZATOSHI);
        MZEC = ZEC.shift(3).minDecimals(2).optionalDecimals(2);
        ZATOSHI = ZEC.shift(7).minDecimals(0).optionalDecimals(2);
    }

    /** The string returned by getId() for the main, production network where people trade things. */
    public static final String ID_ZEC_MAINNET = "main";
    /** The string returned by getId() for the testnet. */
    public static final String ID_ZEC_TESTNET = "test";
    /** The string returned by getId() for regtest. */
    public static final String ID_ZEC_REGTEST = "regtest";

    public static final int ZCASH_PROTOCOL_VERSION_MINIMUM = 170100; // fixme
    public static final int ZCASH_PROTOCOL_VERSION_CURRENT = 170100; // fixme

    private static final Coin BASE_SUBSIDY = Coin.valueOf(50, 0);

    protected Logger log = LoggerFactory.getLogger(AbstractZcashParams.class);

    public AbstractZcashParams() {
        super();
        interval = ZCASH_INTERVAL;
        targetTimespan = ZCASH_TARGET_TIMESPAN;
     ...
     * TODO: this may need updating for Zcash; it is currently copied from Litecoin
     *
    ...
    public int getProtocolVersionNum(final ProtocolVersion version) {
        switch (version) {
            ...
            case CURRENT:
                return ZCASH_PROTOCOL_VERSION_CURRENT;
            case MINIMUM:
            default:
                return ZCASH_PROTOCOL_VERSION_MINIMUM;
        }
    }
