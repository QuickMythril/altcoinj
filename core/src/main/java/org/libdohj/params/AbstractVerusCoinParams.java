...
/*
 * Adapted for VerusCoin in April 2022 by Qortal dev team
 */
...
/**
 * Common parameters for VerusCoin networks.
 */
public abstract class AbstractVerusCoinParams extends NetworkParameters implements AltcoinNetworkParameters {
    /** Standard format for the VRSC denomination. */
    public static final MonetaryFormat VRSC;
    /** Standard format for the mVRSC denomination. */
    public static final MonetaryFormat MVRSC;
    /** Standard format for the "Veroshi" denomination. */
    public static final MonetaryFormat VEROSHI;

    public static final int VERUS_TARGET_TIMESPAN = (int)(2016 * 60); // fixme
    public static final int VERUS_TARGET_SPACING = (int)(1 * 60);  // 60 seconds
    public static final int VERUS_INTERVAL = TARGET_TIMESPAN / TARGET_SPACING;

    /**
     * The maximum number of coins to be generated
     */
    public static final long MAX_COINS = 83540184; // 83,540,184

    /**
     * The maximum money to be generated
     */
    public static final Coin MAX_VERUSCOIN_MONEY = COIN.multiply(MAX_COINS);

    /** Currency code for base 1 VerusCoin. */
    public static final String CODE_VRSC = "VRSC";
    /** Currency code for base 1/1,000 VerusCoin. */
    public static final String CODE_MVRSC = "mVRSC";
    /** Currency code for base 1/100,000,000 VerusCoin. */
    public static final String CODE_VEROSHI = "Veroshi";

    static {
        VRSC = MonetaryFormat.BTC.noCode()
            .code(0, CODE_VRSC)
            .code(3, CODE_MVRSC)
            .code(7, CODE_VEROSHI);
        MVRSC = VRSC.shift(3).minDecimals(2).optionalDecimals(2);
        VEROSHI = VRSC.shift(7).minDecimals(0).optionalDecimals(2);
    }

    /** The string returned by getId() for the main, production network where people trade things. */
    public static final String ID_VRSC_MAINNET = "main";
    /** The string returned by getId() for the testnet. */
    public static final String ID_VRSC_TESTNET = "test";
    /** The string returned by getId() for regtest. */
    public static final String ID_VRSC_REGTEST = "regtest";

    public static final int VERUSCOIN_PROTOCOL_VERSION_MINIMUM = 70000; // fixme
    public static final int VERUSCOIN_PROTOCOL_VERSION_CURRENT = 70001; // fixme

    private static final Coin BASE_SUBSIDY = Coin.valueOf(50, 0);

    protected Logger log = LoggerFactory.getLogger(AbstractVerusCoinParams.class);

    public AbstractVerusCoinParams() {
        super();
        interval = VERUS_INTERVAL;
        targetTimespan = VERUS_TARGET_TIMESPAN;
     ...
     * TODO: this may need updating for VerusCoin; it is currently copied from Litecoin
     *
    ...
    public int getProtocolVersionNum(final ProtocolVersion version) {
        switch (version) {
            ...
            case CURRENT:
                return VERUSCOIN_PROTOCOL_VERSION_CURRENT;
            case MINIMUM:
            default:
                return VERUSCOIN_PROTOCOL_VERSION_MINIMUM;
        }
    }
