 ...
 * Thanks to https://github.com/MatthewLM/peercoinj for the references
 */
...
/**
 * Common parameters for Peercoin networks.
 */
public abstract class AbstractPeercoinParams extends NetworkParameters implements AltcoinNetworkParameters {
    /** Standard format for the PPC denomination. */
    public static final MonetaryFormat PPC;
    /** Standard format for the mPPC denomination. */
    public static final MonetaryFormat MPPC;
    /** Standard format for the "Peeroshi" denomination. */
    public static final MonetaryFormat PEEROSHI;

    public static final int PPC_TARGET_TIMESPAN = (int)(7 * 24 * 60 * 60);  // 1 day
    public static final int PPC_TARGET_SPACING = (int)(10 * 60);  // 10 minutes
    public static final int PPC_INTERVAL = TARGET_TIMESPAN / TARGET_SPACING;

    /**
     * The maximum number of coins to be generated
     */
    public static final long MAX_COINS = 2000000000L; // 2,000,000,000;

    /**
     * The maximum money to be generated
     */
    public static final Coin MAX_PEERCOIN_MONEY = COIN.multiply(MAX_COINS);

    /** Currency code for base 1 Peercoin. */
    public static final String CODE_PPC = "PPC";
    /** Currency code for base 1/1,000 Peercoin. */
    public static final String CODE_MPPC = "mPPC";
    /** Currency code for base 1/100,000,000 Peercoin. */
    public static final String CODE_PEEROSHI = "Peeroshi";

    static {
        PPC = MonetaryFormat.BTC.noCode()
            .code(0, CODE_PPC)
            .code(3, CODE_MPPC)
            .code(7, CODE_PEEROSHI);
        MPPC = PPC.shift(3).minDecimals(2).optionalDecimals(2);
        PEEROSHI = PPC.shift(5).minDecimals(0).optionalDecimals(2);
    }

    /** The string returned by getId() for the main, production network where people trade things. */
    public static final String ID_PPC_MAINNET = "main";
    /** The string returned by getId() for the testnet. */
    public static final String ID_PPC_TESTNET = "test";
    /** The string returned by getId() for regtest. */
    public static final String ID_PPC_REGTEST = "regtest";

    public static final int PEERCOIN_PROTOCOL_VERSION_MINIMUM = 60012;
    public static final int PEERCOIN_PROTOCOL_VERSION_CURRENT = 60012;

    private static final Coin BASE_SUBSIDY = Coin.valueOf(0, 0);

    protected Logger log = LoggerFactory.getLogger(AbstractPeercoinParams.class);

    public AbstractPeercoinParams() {
        super();
        interval = PPC_INTERVAL;
        targetTimespan = PPC_TARGET_TIMESPAN;
     ...
     * TODO: this may need updating for Peercoin; it is currently copied from Litecoin
     *
    ...
    public int getProtocolVersionNum(final ProtocolVersion version) {
        switch (version) {
            ...
            case CURRENT:
                return PEERCOIN_PROTOCOL_VERSION_CURRENT;
            case MINIMUM:
            default:
                return PEERCOIN_PROTOCOL_VERSION_MINIMUM;
        }
    }
