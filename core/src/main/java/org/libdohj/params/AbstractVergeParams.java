...
/**
 * Common parameters for Verge networks.
 */
public abstract class AbstractVergeParams extends NetworkParameters implements AltcoinNetworkParameters {
    /** Standard format for the XVG denomination. */
    public static final MonetaryFormat XVG;
    /** Standard format for the mXVG denomination. */
    public static final MonetaryFormat MXVG;
     ...
     */
    public static final long MAX_COINS = 21000000; // 16,555,000,000;

    /**
     * The maximum money to be generated
     */
    public static final Coin MAX_VERGE_MONEY = COIN.multiply(MAX_COINS);

    /** Currency code for base 1 Verge. */
    public static final String CODE_XVG = "XVG";
    /** Currency code for base 1/1,000 Verge. */
    public static final String CODE_MXVG = "mXVG";
    /** Currency code for base 1/100,000,000 Verge. */
    public static final String CODE_SATOSHI = "Satoshi";

    static {
        XVG = MonetaryFormat.BTC.noCode()
            .code(0, CODE_XVG)
            .code(3, CODE_MXVG)
            .code(7, CODE_SATOSHI);
        MXVG = XVG.shift(3).minDecimals(2).optionalDecimals(2);
        SATOSHI = XVG.shift(7).minDecimals(0).optionalDecimals(2);
    }

    /** The string returned by getId() for the main, production network where people trade things. */
    public static final String ID_XVG_MAINNET = "main";
    /** The string returned by getId() for the testnet. */
    public static final String ID_XVG_TESTNET = "test";
    /** The string returned by getId() for regtest. */
    public static final String ID_XVG_REGTEST = "regtest";

    public static final int VERGE_PROTOCOL_VERSION_MINIMUM = 90009;
    public static final int VERGE_PROTOCOL_VERSION_CURRENT = 90009;

    private static final Coin BASE_SUBSIDY = COIN.multiply(50);

    protected Logger log = LoggerFactory.getLogger(AbstractVergeParams.class);

    public AbstractVergeParams() {
        super();
        interval = VERGE_INTERVAL;
        targetTimespan = VERGE_TARGET_TIMESPAN;
     ...
     * TODO: this may need updating for Verge; it is currently copied from Litecoin
     *
    ...
    public int getProtocolVersionNum(final ProtocolVersion version) {
        switch (version) {
            ...
            case CURRENT:
                return VERGE_PROTOCOL_VERSION_CURRENT;
            case MINIMUM:
            default:
                return VERGE_PROTOCOL_VERSION_MINIMUM;
        }
    }
