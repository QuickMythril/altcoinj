...
/**
 * Common parameters for Ghost networks.
 */
public abstract class AbstractGhostParams extends NetworkParameters implements AltcoinNetworkParameters {
    /** Standard format for the GHOST denomination. */
    public static final MonetaryFormat GHOST;
    /** Standard format for the mGHOST denomination. */
    public static final MonetaryFormat MGHOST;
    /** Standard format for the "Ghostoshi" denomination. */
    public static final MonetaryFormat GHOSTOSHI;

    public static final int GHOST_TARGET_TIMESPAN = (int)(14 * 24 * 60 * 60);  // 2 weeks - https://github.com/ghost-coin/ghost-core/blob/master/src/chainparams.cpp#L487
    public static final int GHOST_TARGET_SPACING = (int)(10 * 60);  // 10 minutes - https://github.com/ghost-coin/ghost-core/blob/master/src/chainparams.cpp#L488
    public static final int GHOST_INTERVAL = TARGET_TIMESPAN / TARGET_SPACING;

    /**
     * The maximum number of coins to be generated
     */
    public static final long MAX_COINS = 55000000;

    /**
     * The maximum money to be generated
     */
    public static final Coin MAX_GHOST_MONEY = COIN.multiply(MAX_COINS);

    /** Currency code for base 1 Ghost. */
    public static final String CODE_GHOST = "GHOST";
    /** Currency code for base 1/1,000 Ghost. */
    public static final String CODE_MGHOST = "mGHOST";
    /** Currency code for base 1/100,000,000 Ghost. */
    public static final String CODE_GHOSTOSHI = "Ghostoshi";

    static {
        GHOST = MonetaryFormat.BTC.noCode()
            .code(0, CODE_GHOST)
            .code(3, CODE_MGHOST)
            .code(7, CODE_GHOSTOSHI);
        MGHOST = GHOST.shift(3).minDecimals(2).optionalDecimals(2);
        GHOSTOSHI = GHOST.shift(7).minDecimals(0).optionalDecimals(2);
    }

    /** The string returned by getId() for the main, production network where people trade things. */
    public static final String ID_GHOST_MAINNET = "main";
    /** The string returned by getId() for the testnet. */
    public static final String ID_GHOST_TESTNET = "test";
    /** The string returned by getId() for regtest. */
    public static final String ID_GHOST_REGTEST = "regtest";

    public static final int GHOST_PROTOCOL_VERSION_MINIMUM = 90013; // GhostToDo - needs confirmed - https://github.com/ghost-coin/ghost-core/blob/master/doc/release-notes-particl.md#019213
    public static final int GHOST_PROTOCOL_VERSION_CURRENT = 90035; // GhostToDo - needs confirmed - https://github.com/ghost-coin/ghost-core/blob/master/doc/release-notes-particl.md#02125

    private static final Coin BASE_SUBSIDY = Coin.valueOf(6, 0); // GhostToDo - needs confirmed
    // 6? - https://github.com/ghost-coin/ghost-core/blob/master/src/chainparams.cpp#L533
    // 50? - https://github.com/ghost-coin/ghost-core/blob/master/src/chainparams.cpp#L669

    protected Logger log = LoggerFactory.getLogger(AbstractGhostParams.class);

    public AbstractGhostParams() {
        super();
        interval = GHOST_INTERVAL;
        targetTimespan = GHOST_TARGET_TIMESPAN;
    ...
    public Coin getMaxMoney() {
        return MAX_GHOST_MONEY;
    }

    @Override
    public Coin getMinNonDustOutput() {
        return Coin.valueOf(1000); // GhostToDo - need to find
    }
     ...
     * TODO: this may need updating for Ghost; it is currently copied from Litecoin
     *
    ...
    public int getProtocolVersionNum(final ProtocolVersion version) {
        switch (version) {
            ...
            case CURRENT:
                return GHOST_PROTOCOL_VERSION_CURRENT;
            case MINIMUM:
            default:
                return GHOST_PROTOCOL_VERSION_MINIMUM;
        }
    }
